 ...
 * @author bsauvan
 */
public abstract class WsProxyLauncher2 {
    ...
    protected WsProxyLauncher2(String[] args) {
    ...
    public void run() {
        String wsUrl = this.deployWsProxy();

        System.out.println("Webservice deployed and running at:\n" + wsUrl);
    }
