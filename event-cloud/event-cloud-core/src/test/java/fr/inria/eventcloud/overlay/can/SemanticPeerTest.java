...
public class SemanticPeerTest {
	...
	public void testSparlqConstructTriplePatternDecomposedWithoutDataAvailable() {
        ...
        SparqlConstructResponse response = 
        	 initializer.getRandomPeer()
        	 	.executeSparqlConstruct(query.toString());

        Assert.assertEquals(0, SemanticHelper.size(response.getResult().toRDF2Go()));
    }
    ...
    public void testAddStatements() {
        ...
        assertEquals(statementsToAdd.length, SemanticHelper.size(response.getResult().toRDF2Go()));
    }
    ...
    public void testSparqlDescribe() {
        ...
        SparqlDescribeResponse response = 
        	initializer.getRandomPeer().executeSparqlDescribe(query.toString());
    ...
    public void testSparqlSelectTriplePattern() {
        ...
        QueryResultTable response = 
        	initializer.getRandomPeer()
        		.executeSparqlSelect(query).getResult().toRDF2Go();
    ...
    public void testSparqlSelectBasicGraphPattern() {
        ...
        QueryResultTable response = 
        	initializer.getRandomPeer()
        		.executeSparqlSelect(query.toString()).getResult().toRDF2Go();
        ClosableIterator<QueryRow> it = response.iterator();
    ...
    public void testSparqlAskTriplePattern() {
        ...
        assertEquals(true, 
        		initializer.getRandomPeer()
        			.executeSparqlAsk(query).getResult());
    }

    public void testRemoveStatement() {
        PAFuture.waitFor(
        		initializer.getRandomPeer().removeStatement(
        				DEFAULT_CONTEXT,
		...
		assertEquals(statementsToAdd.length - 1, SemanticHelper.size(response.getResult().toRDF2Go()));
    }

    public void testRemoveStatements() {
        PAFuture.waitFor(
        		initializer.getRandomPeer().removeStatements(
        				DEFAULT_CONTEXT,
