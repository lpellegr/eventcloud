...
/**
 * The following class has been copied from the Guava project.
 * 
 * TODO: must be removed once Guava 15 is out.
 * 
...
public final class EvictingQueue<E> extends ForwardingQueue<E> {
    ...
    public boolean contains(Object object) {
        return this.delegate().contains(checkNotNull(object));
    }

    @Override
    public boolean remove(Object object) {
        return this.delegate().remove(checkNotNull(object));
    }
