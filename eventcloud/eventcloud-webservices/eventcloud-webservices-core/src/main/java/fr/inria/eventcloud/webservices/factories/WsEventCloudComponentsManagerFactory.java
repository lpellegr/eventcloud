...
/**
 * This class is used to create a {@link WsEventCloudComponentsManager} as an
 * active object.
 * 
 * @author bsauvan
 */
public class WsEventCloudComponentsManagerFactory extends AbstractFactory {
    ...
    public static EventCloudComponentsManager newComponentsManager(NodeProvider componentPoolNodeProvider,
                                                                   ...
                                                                   int nbPutGetProxies) {
        return WsEventCloudComponentsManagerFactory.createComponentsManager(
    ...
    private static EventCloudComponentsManager createComponentsManager(NodeProvider componentPoolNodeProvider,
        ...
        try {
            return PAActiveObject.newActive(
                    WsEventCloudComponentsManager.class, new Object[] {
