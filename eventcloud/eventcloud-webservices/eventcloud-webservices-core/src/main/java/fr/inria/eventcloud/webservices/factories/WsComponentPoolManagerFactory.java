...
import fr.inria.eventcloud.webservices.deployment.WsComponentPoolManager;

/**
 * This class is used to create a {@link WsComponentPoolManager} as an active
 * object.
 * 
 * @author bsauvan
 */
public class WsComponentPoolManagerFactory extends AbstractFactory {
    ...
    public static ComponentPoolManager newComponentPoolManager(NodeProvider componentPoolNodeProvider) {
        return WsComponentPoolManagerFactory.createComponentPoolManager(
