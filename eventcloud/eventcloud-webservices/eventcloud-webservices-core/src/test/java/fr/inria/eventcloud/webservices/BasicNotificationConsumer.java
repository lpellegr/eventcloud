...
/**
 * This class provides a basic implementation of {@link NotificationConsumer} by
 * storing all incoming notifications into an in-memory list. This list can be
 * retrieved at any time for any purpose.
 * 
 * @author lpellegr
 */
public class BasicNotificationConsumer implements NotificationConsumer {

    private final List<Notify> notificationsReceived;
    ...
    public List<Notify> getNotificationsReceived() {
