...
public class DefaultProperties {
	...
	public static final PropertyString CAN_COORDINATE_TYPE =
                            new PropertyString("can.coordinate.element.type", "org.objectweb.proactive.extensions.p2p.structured.overlay.can.coordinates.StringElement");
	...
	public static final PropertyInteger CAN_REFRESH_TASK_START =
	                        new PropertyInteger("can.refresh.task.start", 0);
	
	public static final PropertyInteger CAN_REFRESH_TASK_INTERVAL =
                            new PropertyInteger("can.refresh.task.interval", 500);
