...
public class PeerFactory {
    ...
    /**
     * Creates a new peer component on the specified <code>node</code> by
     * using the given overlay abstraction.
     * 
     * @param overlay
     *            the overlay to set.
    ...
    /**
     * Creates a new peer component on the specified <code>GCM virtual node</code> by
     * using the given overlay abstraction.
     * 
     * @param overlay
     *            the overlay to set.
    ...
    /**
     * Creates a new peer component on <code>node</code> provided by the specified
     * GCM application and by using the given overlay abstraction.
     * 
     * @param overlay
     *            the overlay to set.
     * @param gcma
