...
/**
 * An {@link AsynchronousOperation} is an {@link Operation} which does 
 * not return any response. Hence, all operations extending this kind 
 * of operation are handled asynchronously.
 * 
 * @author lpellegr
 */
