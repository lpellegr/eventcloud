...
public class IsActivatedOperation implements Operation {
    ...
    /**
     * Returns a {@link BooleanResponseOperation} containing {@code true}
     * value if the peer handling this operation is activated, {@code false}
     * otherwise.
     * 
     * @param overlay
     *            the overlay handling the operation.
     * 
     * @return a {@link BooleanResponseOperation} containing {@code true}
     *         value if the peer handling this message is activated,
     *         {@code false} otherwise.
     */
    public BooleanResponseOperation handle(StructuredOverlay overlay) {
        return new BooleanResponseOperation(overlay.getLocalPeer().isActivated());
    }
