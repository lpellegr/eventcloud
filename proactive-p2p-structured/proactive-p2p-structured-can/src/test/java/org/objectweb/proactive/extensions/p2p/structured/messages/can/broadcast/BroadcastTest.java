...
public class BroadcastTest {
    ...
    /**
     * Number of dimensions of the CAN (can be changed through second main
     * method parameter)
     */
        ...
        try {
            ...
            BroadcastInfrastructure broadcastInfrastructure =
                    new BroadcastInfrastructure(
                            nbPeers, JobLogger.getLogDirectory(), null,
                            fractalCAN, uniformCAN);
            ...
            broadcastInfrastructure =
                    new BroadcastInfrastructure(
                            nbPeers, JobLogger.getLogDirectory(), constraint,
                            fractalCAN, uniformCAN);
            broadcastInfrastructure.initialize();
    ...
    /**
     * Removes all log files to be sure that only current logs are taken into
     * account.
     */
